    ...
    <section className="space-y-9 py-6">
      ...
      <div className="text-base lg:text-lg xl:text-xl tracking-wide">
        {t.rich("mainDescription", {
          distributor: (chunk) => (
            <p className={title({ size: "base", color: "orange" })}>
              {chunk}
            </p>
          ),
          companyName: (chunk) => <p className={title({ size: "base", color: "blue" })}>
            {chunk}&nbsp;
          </p>
        })}
      </div>
      <div className="text-base lg:text-lg xl:text-xl tracking-wide pb-8">
        {t.rich("secondP", {
          ...
          companyName: (chunk) => <p className={title({ size: "base", color: "cyan" })}>
            {chunk}&nbsp;
          </p>
        })}
      </div>
