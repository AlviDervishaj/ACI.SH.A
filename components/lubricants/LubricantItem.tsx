  ...
  return (
    <section
      ...
      className={card({
        ...
        hover: "shadow",
        className:
          "min-w-32 w-full h-full group relative sm:w-8/12 md:w-[12.25rem] md:h-fit border border-slate-200 dark:border-slate-700 overflow-hidden",
      })}
    >
      <div className="flex items-center justify-center w-full pt-4 pb-2">
        <div
          className="relative w-28 h-28 md:w-32 md:h-32 rounded-lg overflow-hidden
      ...
      <div className="w-full px-3 pb-2 flex flex-col justify-between items-center">
        <Link
          className={text({
            ...
            tracking: "wide",
            className:
              "text-center hover:border-b-foreground dark:hover:border-b-orange-400 border-b border-b-transparent transition-all duration-300 w-full truncate",
          })}
